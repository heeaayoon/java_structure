...
public class Train_ex03_10_assign_solution {
	public static void show(String msg,Student1[] students) {
	...
	public static void main(String[] args) {
		Student1[] students = { new Student1("S001", "영희", "Math"),
...
//		Integer[] i = {1,4,23,2,5}; //Comparator 객체가 만들어져 있음
//		Arrays.sort(i);

//		정렬과 이진 탐색에 사용할 Comparator<Student> 객체를 람다식(더 중요) 또는 익명 클래스로 구현하기
//		람다식 표현
		Comparator<Student1> sidCompare = (s1, s2) -> s1.getSid().compareTo(s2.getSid());
