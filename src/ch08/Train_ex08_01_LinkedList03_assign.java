package ch08;
/*
 * 01.정수 리스트 > 02.객체 리스트> 03.객체 원형 리스트 
 * 헤드 노드(빈노드)가 있는 원형 리스트, 헤드 노드가 없는 원형 리스트 구현
 * merge 구현
 * 1. in-place 구현 -> 새로운 노드를 만들지 않고 link만 변경
 * 2. 새로운 노드를 생성하여  구현 
 * 원형 이중 리스트로 동일하게 적용
 */
...
public class Train_ex08_01_LinkedList03_assign {
	enum Menu {
